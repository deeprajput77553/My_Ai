...
// ── Chat ──────────────────────────────────────────
export const sendMessage = (message, conversationId, apiProvider, learning = true, analytics = false, options = {}) =>
  API.post("/chat", { message, conversationId, apiProvider, learning, analytics }, options);
